  ...
  const t = useMemo(
    () => ({
      ...
      hi: {
        ...
        gatewaySubtitle:
          "अपने सशक्तिकरण के लिए उपलब्ध योजनाओं का अन्वेषण करें और आवेदन करें।",
        schemeCards: [
          {
  ...
  const getAnnouncements = async () => {
    try {
      const res = await axios.get(
        ...
        }/api/v1/announcement/get_announcement`
      );
    ...
    <div className="bg-orange-50/30 dark:bg-gray-900/50 relative transition-colors duration-300">
      ...
      <div className="py-20 bg-white dark:bg-gray-900 relative overflow-hidden transition-colors duration-500">
        ...
        <div className="relative z-10 text-center">
          <p className="text-4xl font-bold text-amber-600 dark:text-amber-400 md:text-5xl lg:text-6xl tracking-widest">
            {S.howItWorks}
          </p>
          ...
          {S.steps.map((step, index) => {
            const colors = [
              ...
              },
              {
                ...
                bg: "bg-orange-100 dark:bg-orange-700/20",
              },
