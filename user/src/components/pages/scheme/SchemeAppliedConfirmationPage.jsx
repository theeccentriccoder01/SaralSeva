...
const SchemeAppliedConfirmationPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] bg-orange-50/30 p-4">
      <div className="w-full max-w-2xl bg-white p-8 sm:p-10 text-center rounded-2xl shadow-2xl border-t-8 border-amber-500">
        <img src={success} alt="Success" className="w-28 mx-auto"/>
        <h1 className="text-3xl font-extrabold text-orange-900 mt-4 jost">Application Submitted!</h1>
        <p className="text-lg text-gray-600 mt-4 leading-relaxed">
          Your application for the <span className="font-bold text-stone-800">{scheme?.scheme_name}</span> scheme has been successfully submitted. Your registration number is <span className="font-bold text-stone-800">{scheme?.registration_no}</span>.
        </p>
