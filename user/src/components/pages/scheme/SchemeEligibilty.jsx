...
const SchemeEligibilty = () => {
  return (
    <div className="px-[5vw] lg:px-[10vw] py-12 bg-orange-50/30">
      <div className="flex flex-col lg:flex-row items-center gap-12 p-8 bg-white rounded-2xl shadow-xl">
        <div className="lg:w-1/2">
          <img src={find} alt="Find your perfect scheme" className="w-full max-w-md mx-auto"/>
        </div>
        <div className="lg:w-1/2">
          <h1 className="text-4xl font-extrabold text-orange-900 jost">Did you find your perfect scheme?</h1>
      ...
      <div className="mt-20">
        <h2 className="text-4xl font-extrabold text-center text-orange-900 jost">Scheme Eligibility Criteria</h2>
        <div className="max-w-4xl mx-auto mt-8">
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <AccordionTrigger className="px-6 py-4 text-lg font-semibold text-stone-800 hover:no-underline">Pradhan Mantri Awas Yojana</AccordionTrigger>
            ...
            <AccordionItem value="item-2" className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <AccordionTrigger className="px-6 py-4 text-lg font-semibold text-stone-800 hover:no-underline">Mudra Yojana</AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-700 space-y-2">
            ...
            <AccordionItem value="item-3" className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <AccordionTrigger className="px-6 py-4 text-lg font-semibold text-stone-800 hover:no-underline">Mahila Samriddhi Yojana</AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-700 space-y-2">
