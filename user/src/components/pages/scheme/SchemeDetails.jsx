  ...
  return (
    <div className="px-[5vw] flex justify-between gap-10 py-12 bg-orange-50/30 dark:bg-gray-900/30">
      ...
      <main className="w-full lg:w-3/5 bg-white dark:bg-gray-800 dark:text-gray-200 p-8 sm:p-10 rounded-2xl shadow-2xl dark:shadow-black/40">
        <h1 className="text-4xl font-extrabold text-orange-900 dark:text-amber-400 jost">{scheme.scheme_name}</h1>
        <p className="mt-2 text-lg font-semibold text-gray-500 dark:text-gray-300 uppercase">{scheme.scheme_dept}</p>

        <Element name="details" className="mt-12">
          <h2 className="text-3xl font-bold text-orange-800 dark:text-amber-400 jost border-b-2 border-amber-300 pb-2">Details</h2>
          <p className="mt-4 text-gray-600 dark:text-gray-300">
            Scheme Code: <span className="font-semibold text-stone-800 dark:text-gray-200">{scheme.scheme_code}</span>
          </p>
          <p className="mt-4 text-lg leading-relaxed text-gray-700 dark:text-gray-300">{scheme.scheme_details}</p>
        </Element>

        <Element name="benefits" className="mt-12">
          <h2 className="text-3xl font-bold text-orange-800 dark:text-amber-400 jost border-b-2 border-amber-300 pb-2">Benefits</h2>
        ...
        <Element name="eligibility" className="mt-12">
          <h2 className="text-3xl font-bold text-orange-800 dark:text-amber-400 jost border-b-2 border-amber-300 pb-2">Eligibility</h2>
          <ul className="mt-4 space-y-3 list-disc list-inside text-lg text-gray-700 dark:text-gray-300">
        ...
        <Element name="application" className="mt-12">
          <h2 className="text-3xl font-bold text-orange-800 dark:text-amber-400 jost border-b-2 border-amber-300 pb-2">Application Process</h2>
          <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">1. Registration on SaralSeva Portal: <RouterLink to="/register" className="font-semibold text-orange-700 dark:text-amber-300 hover:underline">Register</RouterLink></p>
          <p className="mt-3 text-lg text-gray-700 dark:text-gray-300">2. Already have an account? <RouterLink to="/login" className="font-semibold text-orange-700 dark:text-amber-300 hover:underline">Login</RouterLink></p>
          <p className="mt-3 text-lg text-gray-700 dark:text-gray-300">3. Fill in the required details in the scheme application form.</p>
        </Element>

        <Element name="document" className="mt-12">
          <h2 className="text-3xl font-bold text-orange-800 dark:text-amber-400 jost border-b-2 border-amber-300 pb-2">Documents Required</h2>
          <ul className="mt-4 space-y-3 list-disc list-inside text-lg text-gray-700 dark:text-gray-300">
        ...
        <Element name="sources" className="mt-12">
          <h2 className="text-3xl font-bold text-orange-800 dark:text-amber-400 jost border-b-2 border-amber-300 pb-2">Sources and References</h2>
          <button onClick={handleClick} className="flex items-center gap-2 mt-4 text-lg font-semibold text-orange-700 dark:text-amber-300 transition-transform hover:scale-105">
            View Guidelines <ExternalLink className="hover:text-amber-600 dark:hover:text-orange-400" />
          </button>
        </Element>
      </main>
      ...
      <aside className="w-1/5 sticky top-24 self-start hidden lg:block">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg dark:shadow-black/40">
          <h3 className="bg-orange-100 dark:bg-orange-900 text-orange-900 dark:text-amber-300 font-bold p-3 rounded-t-lg">News and Updates</h3>
          <p className="p-3 text-gray-500 dark:text-gray-300">No new updates available.</p>
          <h3 className="bg-orange-100 dark:bg-orange-900 text-orange-900 dark:text-amber-300 font-bold p-3 mt-4 rounded-t-lg">Share This Scheme</h3>
