...
const ProfileInfoRow = ({ label, value }) => (
    <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
        ...
        <dd className="mt-1 text-md text-stone-800 dark:text-stone-200 sm:mt-0 sm:col-span-2 font-semibold">{value}</dd>
    </div>
)
...
const Profile = () => {
    ...
    if (!user) {
        return <div className="h-[60vh] flex items-center justify-center text-xl text-gray-500 dark:text-gray-400">Loading Profile...</div>;
    }      
        ...
        <div className='px-[5vw] py-12 bg-orange-50/30 dark:bg-gray-900/30'>
            <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl dark:shadow-black/40 overflow-hidden">
                <div className="p-6 sm:p-8 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    ...
                    <Button className='gap-2 bg-amber-500 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-700 text-orange-900 dark:text-gray-900 font-bold shadow-md hover:shadow-lg transition-all'>
